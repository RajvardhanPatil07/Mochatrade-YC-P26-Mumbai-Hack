...
class AlpacaHistoricalProvider:
    ...
    def _normalize_snapshot(raw: object, feed: str) -> dict:
        if not isinstance(raw, dict):
            return {"status": "UNAVAILABLE", "price": None, "previous_close": None, "change_pct": None, "event_time": None, "bid": None, "ask": None, "day_volume": None, "feed": feed, "is_delayed": feed == "delayed_sip"}
        ...
        return {
            ...
            "day_volume": volume, "feed": feed, "is_delayed": feed == "delayed_sip",
        }
